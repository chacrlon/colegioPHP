...
<br><br><br>
   ...
   <div class="container">
    ...
    <div class="modal-header fondorojo letrablanca">
        ...
        <center><h4 class="modal-title " id="myModalLabel">Planilla de Registro de Noticias</h4></center>
    </div>
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" class="form-control" name="titulo" placeholder="Título de la Publicación" autofocus required> 
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea rows="10" name="descripcion" class="form-control" placeholder="Descripción de la Publicación" required></textarea>
                            ...
                            <tr>
                                <td colspan="4">
                                    ...
                                    <button class="btn btn-default btn-lg btn-block fondogris letraroja" type="submit">Publicar Noticia</button>   
                                </td>
                            </tr>
