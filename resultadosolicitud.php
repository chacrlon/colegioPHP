  ...
  <div id="modal3" class="modalmask">
   ...
   <div class="container">
    ...
    <div class="col hidden-xs hidden-sm col-md-3 col-lg-3">
        <img src="img/cuestionario.gif" class="img img-responsive">

    </div>
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
    <div class="modal-header fondorojo letrablanca">
        
        <center><h4 class="modal-title " id="myModalLabel">Consultar Solicitud de Inscripción</h4></center>
    </div>

    <form  action="consultarsolicitud.php" method="GET">    
    <table align="center" class="table">
        <tr>
            <td>
                <input type="text" class="form-control" name="idsolicitud" placeholder="Cédula del Estudiante" required autofocus> 
    ...
    <div class="col hidden-xs hidden-sm col-md-3 col-lg-3">
        <img src="img/resultados.gif" class="img img-responsive">
