...
<div id="modal2" class="modalmask">
  ...
  if(mysql_num_rows($resultado2) == 0){
    ...
    <form  action="registrarrepresentante.php" method="POST" enctype = "multipart/form-data" >        
                        ...
                        <tr>
                                ...
                                <td>
                                    &nbsp; 
                                    <input type="hidden" name="cedula1" value="'.$cedula1.'">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <a href="validarrepresentante.php" class="btn btn-default btn-lg btn-block fondogris letraroja" >Cancelar Operación</a>   
                                </td>
                            </tr>
...
echo "<script language='javascript'>window.location.href='Estudiante.php?id_repre=".$idest_representante."';</script>"; 
}
