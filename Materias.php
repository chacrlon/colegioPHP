...
<br><br><br>
 ...
 <div class="col hidden-xs hidden-sm col-md-3 col-lg-3">
    ...
    <div class="modal-header fondorojo letrablanca">
        ...
        <center><h4 class="modal-title " id="myModalLabel">Planilla para agregar una nueva Materia</h4></center>
    </div>
    <form  action="registrarmateria.php" method="POST" name="agregarperiodo">        
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" class="form-control" name="codigomateria" placeholder="Código de la Materia" autofocus required> 
                                </td>
                                <td>
                                    <strong>Nombre de la Materia</strong>
                                    <input type="text" class="form-control" name="nombremateria" placeholder="Nombre de la Materia" autofocus required> 
                                </td>
                            <tr>
                            <tr>
                                <td>
                                    <strong>Nota Mínima</strong>
                                    <input type="number" class="form-control" name="notaminima" placeholder="Nota Mínima" autofocus required> 
                                </td>
                                <td>
                                    <strong>Año al que Pertenece</strong>
                            ...
                            <tr>
                                <td >
                                    ...
                                    <button class="btn btn-default btn-lg btn-block fondogris letraroja" type="submit">Agregar Materia</button>   
                                </td>
                                <td >
                                
                                    <a href="consultarmaterias.php" class="btn btn-default btn-lg btn-block fondogris letraroja ">Cancelar</a> 
                                </td>
