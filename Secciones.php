...
<br><br><br>
 ...
 <div class="col hidden-xs hidden-sm col-md-3 col-lg-3">
    ...
    <div class="modal-header fondorojo letrablanca">
        ...
        <center><h4 class="modal-title " id="myModalLabel">Planilla para agregar una nueva Sección</h4></center>
    </div>
    <form  action="registrarseccion.php" method="POST" name="agregarperiodo">        
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <strong>Código de la Sección</strong>
                                    <input type="text" class="form-control" name="codigoseccion" placeholder="Código de la Sección" autofocus required> 
                                </td>
                                <td>
                                    <strong>Nombre de la Sección</strong>
                                    <input type="text" class="form-control" name="nombreseccion" placeholder="Nombre de la Sección" autofocus required> 
                                </td>
                            <tr>
                            ...
                            <tr>
                                <td >
                                    ...
                                    <button class="btn btn-default btn-lg btn-block fondogris letraroja" type="submit">Agregar Sección</button>   
                                </td>
                                <td >
                                
                                    <a href="consultarsecciones.php" class="btn btn-default btn-lg btn-block fondogris letraroja ">Cancelar</a> 
                                </td>
