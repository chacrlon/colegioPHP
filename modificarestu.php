...
if(!Autenticado()){
    ...
    if($tipoU != "SuperUser"){
      echo "<script language='javascript'> alert('Usuario sin permisos para esta acción!'); window.history.go(-1);</script>";
        ...
        $status1=$_POST["statusestudiante"];
        ...
        $plantel1=$_POST["plantel"];
        $direccion1=$_POST["direccion"];
        
        $idestudiantee=$_POST["idestudiantemod"];


        $sql = "UPDATE estudiante SET nombre1='".$nombre1."', nombre2='".$nombre2."',apellido1='".$apellido1."'
    ...
    ,direccion='".$direccion1."',plantel_procedencia='".$plantel1."',status='".$status1."'
     WHERE id_estudiante='".$idestudiantee."';" ;
