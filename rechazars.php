...
<br><br><br>
   ...
   <div class="container">
    ...
    $idsolicitudaprobar=$_POST['idsolapro'];
    $idestudiante=$_POST['idestudiante'];

    $aniosol=$_POST['aniosol'];
   

    $sql = "SELECT id_representante FROM estudiante WHERE id_estudiante='$idestudiante'";
    $resultado = mysql_query($sql)or die(mysql_error());

    if(mysql_num_rows($resultado) == 0){
    echo "<script language='javascript'> alert('No hay representante registrado para este Estudiante...');</script>";              
...
$sql2 = "SELECT id_representante FROM estudiante WHERE id_representante='$idrepresentante'";
    $resultado2 = mysql_query($sql2)or die(mysql_error());

    $total2=mysql_num_rows($resultado2);

    if($total2<2){
        $sql3 = "DELETE FROM representante WHERE id_representante='$idrepresentante'";
        $resultado3 = mysql_query($sql3)or die(mysql_error());
    }
     $sql4 = "DELETE FROM estudiante WHERE id_estudiante='$idestudiante'";
    $resultado4 = mysql_query($sql4)or die(mysql_error());
    
    $sql5 = "DELETE FROM Solicitudes WHERE id_solicitud='$idsolicitudaprobar'";
    $resultado5 = mysql_query($sql5)or die(mysql_error());


    echo "<script language='javascript'> alert('Solicitud Eliminada Exitosamente');</script>";              
