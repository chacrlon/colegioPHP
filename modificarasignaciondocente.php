...
<head>
    ...
    <script type="text/javascript">
      ...
      function confirmar(){
        if(confirm("Seguro que desea cambiar al Docente? Una vez que realice esta acción el Docente no podrá acceder a esta Materia...")){
            return true;
        }
        else{
            return false;
...
<br><br><br>
   ...
   <div class="container">
    ...
    $sql4 = "SELECT * FROM periodo WHERE id_periodo='$idperiodo'";
        ...
        $sql6 = "SELECT * FROM docente WHERE id_docente='$iddocente'";
        if($resultado6 = mysql_query($sql6)){
            while($fila6 = mysql_fetch_array($resultado6)){
                $nombredocente=$fila6["nombre1"];
                $apellidodocente=$fila6["apellido1"];
                $ceduladocente=$fila6["cedula"];
            }
        }
...
echo'
    ...
    <div class="modal-header fondorojo letrablanca">
        ...
        <center><h4 class="modal-title " id="myModalLabel">Planilla de Cambio de Docente</h4></center>
    </div>
    <form  action="modificarasignaciondedocente.php" method="POST" onsubmit="return confirmar()">        
                            ...
                            <tr>
                                <td colspan="3">
                                    <strong>Docente para Asignar</strong>
                                            ...
                                            $sql2 = "SELECT * FROM docente where status=1 AND id_docente!='$iddocente'";
                                            $resultado2 = mysql_query($sql2)or die(mysql_error());  
                                            if(mysql_num_rows($resultado2) == 0){
                                                


                                                echo "<script language='javascript'> alert('No hay más docentes disponibles!');</script>"; 
                                ...
                                echo'
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            ...
                                            <button class="btn btn-default btn-lg btn-block fondogris letraroja" type="submit" disabled="disabled">Cambiar Docente</button>   
                                         </td>
                                    </tr>';
                             }
                             else{
                                echo'
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            ...
                                            <button class="btn btn-default btn-lg btn-block fondogris letraroja" type="submit" >Cambiar Docente</button>   
                                         </td>
                                    </tr>';
                             }
